...
use App\Services\Mobile\StudentDictationService;
...
{
    public function __construct(private StudentDictationService $service)
    {
    }
    ...
    public function index(StudentDictationsIndexRequest $request): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => __('mobile/student/dictations.errors.unexpected'),
            ], 500);
        }
    }
}